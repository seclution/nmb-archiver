...
Der Fokus dieses Forks liegt auf dem produktiven Einsatz für Kundenumgebungen und auf der Erweiterung um die Integration in ein hauseigenes revisionssicheres Backend. Ziel ist eine belastbare Beweiskette für Archivierung, Ansicht und Verifikation von E-Mails und Attachments, ohne die Offenheit des öffentlichen AGPL-Upstreams aufzugeben.
...
- Universal Ingestion für Google Workspace, Microsoft 365, IMAP, PST, `.eml`-Archive und Mbox
- Speicherung im Standardformat `.eml` mit separater Attachment-Verwaltung
- Lokales Dateisystem oder S3-kompatibler Objektspeicher
- Volltextsuche über E-Mails und Attachments
- Integritätsprüfung über Rehash von Mail, Attachments und kanonischem Root-Hash
- Audit-Log für nachvollziehbare Zugriffe und Systemaktionen
...
- Ein Host mit mindestens 4 GB RAM, oder weniger bei extern betriebenem Postgres, Redis/Valkey und Meilisearch
